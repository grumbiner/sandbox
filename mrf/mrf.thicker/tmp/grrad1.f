...
C.....sof   comfver...............................................
C....
      DIMENSION DGRS( 258 , 28 )
      DIMENSION PLAMGR( 258 ),PPHIGR( 258 )
      DIMENSION UGRS( 258 , 28 ),VGRS( 258 , 28 )
      DIMENSION TGRS( 258 , 28 ),QGRS( 258 , 28 )
      DIMENSION PGR( 258 )
C....
      DIMENSION WORKR( 256 ,LWORKR)
C....
      DIMENSION COSZER( 256 )
C....
      DIMENSION RRS2( 31 )
      DIMENSION RLON( 256 ),RLAT( 256 )
      DIMENSION ALBEDR( 256 ),SLMSKR( 256 )
...
CYH94 DIMENSION CLDARY( 256 , 28 ),CLSTR( 256 )
      ...
      DIMENSION CLDTOT( 256 , 28 ),CLDCNV( 256 , 28 )
      DIMENSION SFCP( 256 )
      DIMENSION ICNV( 256 )
...
CTOT 2             CLDSA( 256 ,3),MTOPA( 256 ,3),MBOTA( 256 ,3),
     ...
     3             COSZRO( 256 ),TAUDAR( 256 ),WRKEMA( 256 ),
     4             TSEAR( 256 ),SHELGR( 256 ),
     5             CVR( 256 ),CVTR( 256 ),CVBR( 256 ),
C                  ADDED BY BOB GRUMBINE FOR SEA ICE ALBEDO ALGORITHM
     6             TGR( 256 )
      DIMENSION    AVECV(3, 62 ),AVECLD( 28 , 62 ),CLDL(4, 62 )
C....
CYH93...
...
C...      GET MODEL DIAGNOSED CLDS
      CALL CLDJMS( 256 , 258 , 28 ,NBIN,MCLD,
...
C        **********************************************
     ...
     1              DTSWAV, 256 ,COSZRO(1),TAUDAR(1))
      ELSE
C        **********************************
