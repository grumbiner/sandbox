...
C
C-CLR DIMENSION HEATR0(IMBX,L),FLXNT0(IMBX,LP1)
C-CLR DIMENSION GRNFX0(IMAX),TOPFX0(IMAX),GXCTS0(IMAX),FLX1E0(IMAX)
C-CLR DIMENSION EXCTS0(IMBX,L),CTSO30(IMBX,L),CTS0(IMBX,L)
C-CLR DIMENSION FLX0(IMBX,LP1)
C
...
C-CLR DO 2305 K=2,LP1
C-CLR DO 2305 I=1,IMAX
C-CLR FLX0(I,K)=  TC(I,1)*E1FLX(I,K)
C-CLR1          +SS1(I,1)*CNTTAU(I,K-1)
C-CLR2          +SORC(I,1,13)*TO3SP(I,K-1)
C-CLR3          +CSOUR(I,1)*CO2SP(I,K)
2305  CONTINUE
C-CLR DO 2307 I=1,IMAX
C-CLR FLX0(I,1)=TC(I,1)*E1FLX(I,1)+SS1(I,1)+SORC(I,1,13)
C-CLR1          +CSOUR(I,1)
2307  CONTINUE
C---THE KP TERMS FOR K=1...
C-CLR DO 2303 KP=2,LP1
C-CLR  DO 2303 I=1,IMAX
C-CLR   FLX0(I,1)=FLX0(I,1)+ OSS(I,KP)*TO3SP(I,KP-1)
C-CLR1                  +SS2(I,KP)*CNTTAU(I,KP-1)
C-CLR2                  +CSS(I,KP)*CO21(I,KP,1)
C-CLR3                  +DTC(I,KP)*EMISS(I,KP-1)
2303  CONTINUE
...
1014  CONTINUE
C  ... DITTO FOR CLEAR SKY  ...
C-CLR DO 2998 I=1,IMAX
C-CLR  VTMP3(I,1)=1.
2998  CONTINUE
C-CLR DO 2999 K=1,L
C-CLR DO 2999 I=1,IMAX
C-CLR  VTMP3(I,K+1)=CNTTAU(I,K)
2999  CONTINUE
C-CLR DO 2001 K=1,L
C-CLR DO 2001 I=1,IMAX
C-CLR  CTS0(I,K)=RADCON*DELP(I,K)*(TC(I,K)*
C-CLR1     (E1CTW2(I,K)-E1CTW1(I,K)) +
C-CLR2      SS1(I,K)*(VTMP3(I,K+1)-VTMP3(I,K)))
2001  CONTINUE
C
C-CLR DO 2011 K=1,L
C-CLR DO 2011 I=1,IMAX
C-CLR  VTMP3(I,K)=TC(I,K)*(E1CTS1(I,K)-E1CTW1(I,K)  -
C-CLR1                    (E1CTS2(I,K)-E1CTW2(I,K)))
2011  CONTINUE
C-CLR DO 2012 I=1,IMAX
C-CLR  FLX1E0(I)=TC(I,LP1)*
C-CLR1          (E1CTS1(I,LP1)-E1CTW1(I,LP1))
2012  CONTINUE
C-CLR DO 2014 K=1,L
C-CLR  DO 2013 I=1,IMAX
C-CLR   FLX1E0(I)=FLX1E0(I)+VTMP3(I,K)
2013   CONTINUE
2014  CONTINUE
C
...
C-CLR DO 2423 KP=K+1,LP1
C-CLR  DO 2423 I=1,IMAX
C-CLR   FLX0(I,K)=FLX0(I,K)+ OSS(I,KP)*TO31D(I,KP-1)
C-CLR1                  +SS2(I,KP)*CONT1D(I,KP-1)
C-CLR2                  +CSS(I,KP)*CO21(I,KP,K)
C-CLR3                  +DTC(I,KP)*EMISS(I,KP-1)
2423  CONTINUE
C-CLR DO 2425 KP=K+1,LP1
C-CLR  DO 2425 I=1,IMAX
C-CLR   FLX0(I,KP)=FLX0(I,KP)+ OSS(I,K)*TO31D(I,KP-1)
C-CLR1                   +SS2(I,K)*CONT1D(I,KP-1)
C-CLR2                   +CSS(I,K)*CO21(I,K,KP)
C-CLR3                   +DTC(I,K)*EMISSB(I,KP-1)
2425  CONTINUE
321   CONTINUE
C
...
873   CONTINUE
C ...   DITTO FOR CLEAR SKY ... CLDFAC =1.
C-CLR DO 2871 K=2,LP1
C-CLR  DO 2871 I=1,IMAX
C-CLR   FLX0(I,K)=FLX0(I,K)+ DTC(I,K)*EMISDG(I,K)
C-CLR1                 +SS2(I,K)*CONTDG(I,K)
C-CLR2                 +OSS(I,K)*TO3DG(I,K)
C-CLR3                 +CSS(I,K)*CO21(I,K,K)
2871  CONTINUE
C     FOR THE TWO OFF-DIAGONAL TERMS...
C-CLR DO 2873 I=1,IMAX
C-CLR  FLX0(I,L)=FLX0(I,L)+ CSS(I,LP1)*CO21(I,LP1,L)
C-CLR1                  +DTC(I,LP1)*EMSPEC(I,2)
C-CLR2                  +OSS(I,LP1)*TO31D(I,L)
C-CLR3                  +SS2(I,LP1)*CONT1D(I,L)
C-CLR  FLX0(I,LP1)=FLX0(I,LP1)+ CSS(I,L)*CO21(I,L,LP1)
C-CLR1                      +OSS(I,L)*TO31D(I,L)
C-CLR2                      +SS2(I,L)*CONT1D(I,L)
C-CLR3                      +DTC(I,L)*EMSPEC(I,1)
2873  CONTINUE
C
...
C ...   DITTO FOR CLEAR SKY .. CLDFAC=1.
C-CLR DO 2101 K=1,L
C-CLR DO 2101 I=1,IMAX
C-CLR  HEATEM(I,K)=RADCON*(FLX0(I,K+1)-FLX0(I,K))*DELP(I,K)
2101  CONTINUE
C     .....CALCULATE THE TOTAL HEATING RATES
C-CLR DO 2103 K=1,L
C-CLR DO 2103 I=1,IMAX
C-CLR  HEATR0(I,K)=HEATEM(I,K)-CTS0(I,K)-CTSO30(I,K)+EXCTS0(I,K)
2103  CONTINUE
C     .....CALCULATE THE FLUX AT EACH FLUX LEVEL USING THE FLUX AT THE
C    TOP (FLX1E1+GXCTS) AND THE INTEGRAL OF THE HEATING RATES (VSUM1)
C-CLR DO 2111 K=1,L
C-CLR DO 2111 I=1,IMAX
C-CLR  VSUM1(I,K)=HEATR0(I,K)*DELP2(I,K)*RADCON1
2111  CONTINUE
C-CLR DO 2115 I=1,IMAX
C-CLR  TOPFX0(I)=FLX1E0(I)+GXCTS0(I)
C-CLR  FLXNT0(I,1)=TOPFX0(I)
2115  CONTINUE
C---ONLY THE SURFACE VALUE OF FLUX (GRNFLX) IS NEEDED UNLESS
C    THE THICK CLOUD SECTION IS INVOKED.
C-CLR DO 2123 K=2,LP1
C-CLR  DO 2123 I=1,IMAX
C-CLR   FLXNT0(I,K)=FLXNT0(I,K-1)+VSUM1(I,K-1)
2123  CONTINUE
C-CLR DO 2125 I=1,IMAX
C-CLR  GRNFX0(I)=FLXNT0(I,LP1)
2125  CONTINUE
C
