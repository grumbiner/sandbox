#!/bin/sh
#@ job_type=serial
#@ output=/u/wx21rg/newamsr.ops2009.out
#@ error=/u/wx21rg/newamsr.ops2009.err
#@ class=1
...
SYSTEM=IBM
  RUNDIR=/stmp/wd21rg/ops.2009
  EXDIR=/u/wx21rg/rgdev/ice1/ops2009.execs/
  FIX=/u/wx21rg/rgdev/ice1/ops2009.fix/
  OUTDIR=/u/wx21rg/noscrub/ops.2009/
