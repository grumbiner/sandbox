...
C     Local Utility variables
      ...
      CALL W3TAGB('PSGSOUTH',1998,0029,0095,'NP21   ')
...
C$*****************************************************************************
  ...
  250 CM=COS(SL)/SQRT(1.0-E2*(SIN(SL)**2))
     ...
     1 ((7.0*E2**2.0/48.0)+(29.0*E2**3/240.0))*SIN(4.0*CHI)+
     1 (7.0*E2**3.0/120.0)*SIN(6.0*CHI)
...
C   Robert Grumbine                                98-07-21 Y2K and F90
C
...
C   98-07-21  Grumbine Y2K and F90
C
