...
/* Mallocate the ssmi arrays */
  north_tmp = (ssmi_tmp *) malloc( sizeof(ssmi_tmp) * NX_NORTH*NY_NORTH);
  south_tmp = (ssmi_tmp *) malloc( sizeof(ssmi_tmp) * NX_SOUTH*NY_SOUTH);
  north     = (ssmi *) malloc( sizeof(ssmi) *NX_NORTH*NY_NORTH);
  south     = (ssmi *) malloc( sizeof(ssmi) *NX_SOUTH*NY_SOUTH);
