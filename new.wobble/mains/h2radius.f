...
!      step = step/stepsize
 ...
 1000 CONTINUE
      ...
      CALL analy(x, m, freq, n, stepsize)
...
!      CALL analy(lod, m, freq, n)
      ...
      SUBROUTINE analy(x, m, freq, n, stepsize)
      IMPLICIT none
      INTEGER m, n
      REAL x(m), freq(n), stepsize
...
CD     1              ATAN2(b(i),a(i))*180./pi 
        WRITE (12,9002) freq(i)/2./pi/stepsize, 
     1              (a(i)*a(i)+b(i)*b(i))**.5,
