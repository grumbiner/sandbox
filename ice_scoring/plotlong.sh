...
export com=${com:-$basecom/com/mmab/developer}
...
cp ${com}/${model}_${version}.$PDY/scoreout.$PDY kissout1

export model=gfs
export version=v1.0.0
cp ${com}/${model}_${version}.$PDY/scoreout.$PDY gfsout

export model=cfs
export version=v2.0.0
cp ${com}/${model}_${version}.$PDY/scoreout.$PDY cfsout

export model=acnfs
export version=v0.0.0
cp ${com}/${model}_${version}.$PDY/scoreout.$PDY acnfsout
