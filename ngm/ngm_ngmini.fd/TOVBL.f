       SUBROUTINE TOVBL(W0U,W0V,W0TH,W0Q,W0H,NG)
C$$$  SUBPROGRAM DOCUMENTATION BLOCK
C                .      .    .                                       .
C SUBPROGRAM:    TOVBL       MOVE PRINCIPLE VBLS FROM W0U, ETC TO VBL
C   PRGMMR: PARRISH          ORG: W/NMC22    DATE: 88-08-08
C
C ABSTRACT: MOVE PRINCIPLE VARIABLES FROM W0U, ETC TO VBL ARRAY.
C
C PROGRAM HISTORY LOG:
C   88-08-08  PARRISH
C
C USAGE:    CALL TOVBL(W0U,W0V,W0TH,W0Q,W0H,NG)
...
C
      COMMON /COM1WAY/ ITIMSTEP, ITBOUND, INGLB
         ...
         REAL W0TH(IIJMAX,1),W0Q(IIJMAX,1)
         REAL W0H(1)
C--------
         IJ=IMG(NG)*JMG(NG)
         MADDU=IADDRG(1,NG)
         ...
         DO 100 K=1,KM
           DO 10002 I=1,IJ
             VBL(MADDU+I-1)=W0U(I,K)
             VBL(MADDV+I-1)=W0V(I,K)
             VBL(MADDT+I-1)=W0TH(I,K)
             VBL(MADDQ+I-1)=W0Q(I,K)
10002      CONTINUE
           MADDU=MADDU+IJ
           MADDV=MADDV+IJ
           MADDT=MADDT+IJ
