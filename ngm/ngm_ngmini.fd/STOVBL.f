       SUBROUTINE STOVBL(W0U,W0V,W0TH,NG)
C$$$  SUBPROGRAM DOCUMENTATION BLOCK
C                .      .    .                                       .
C SUBPROGRAM:    STOVBL      MOVE PRINCIPLE VBLS TO VBL FROM W0U, ETC
C   PRGMMR: PARRISH          ORG: W/NMC22    DATE: 88-08-08
C
C ABSTRACT: MOVE PRINCIPLE VARIABLES TO VBL ARRAY FROM W0U, ETC.
C   BUT ONLY FIRST NUMVERT LAYERS ARE MOVED.
C
C PROGRAM HISTORY LOG:
C   88-08-08  PARRISH
C
C USAGE:    CALL STOVBL(W0U,W0V,W0TH,NG)
