       SUBROUTINE CFROMVBL(VBLCOPY,NG,IADDRGDP)
C$$$  SUBPROGRAM DOCUMENTATION BLOCK
C                .      .    .                                       .
C SUBPROGRAM:    CFROMVBL    MOVE STUFF FROM VBL TO VBLCOPY
C   PRGMMR: PARRISH          ORG: W/NMC22    DATE: 88-08-08
C
C ABSTRACT: MOVE EVERYTHING FROM VBL ARRAY TO VBLCOPY ARRAY.
C
C PROGRAM HISTORY LOG:
C   88-08-08  PARRISH
C
C USAGE:    CALL CFROMVBL(VBLCOPY,NG,IADDRGDP)
