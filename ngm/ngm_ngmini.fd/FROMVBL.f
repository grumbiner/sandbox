       SUBROUTINE FROMVBL(W0U,W0V,W0TH,W0Q,W0H,NG)
C$$$  SUBPROGRAM DOCUMENTATION BLOCK
C                .      .    .                                       .
C SUBPROGRAM:    FROMVBL     MOVE PRINCIPLE VBLS FROM VBL TO W0U, ETC
...
C   88-08-08  PARRISH
C
C USAGE:    CALL FROMVBL(W0U,W0V,W0TH,W0Q,W0H,NG)
...
C--------
         ...
         DO 100 K=1,KM
           DO 10002 I=1,IJ
             W0U(I,K)=VBL(MADDU+I-1)
             W0V(I,K)=VBL(MADDV+I-1)
             W0TH(I,K)=VBL(MADDT+I-1)
             W0Q(I,K)=VBL(MADDQ+I-1)
10002      CONTINUE
           MADDU=MADDU+IJ
           MADDV=MADDV+IJ
           MADDT=MADDT+IJ
