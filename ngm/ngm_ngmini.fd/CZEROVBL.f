       SUBROUTINE CZEROVBL(VBLCOPY,NG,IADDRGDP)
C$$$  SUBPROGRAM DOCUMENTATION BLOCK
C                .      .    .                                       .
C SUBPROGRAM:    CZEROVBL    ZERO STUFF IN VBLCOPY
C   PRGMMR: PARRISH          ORG: W/NMC22    DATE: 88-08-08
C
C ABSTRACT: ZERO PRINCIPLE VARIABLES IN VBLCOPY ARRAY.
C
C PROGRAM HISTORY LOG:
C   88-08-08  PARRISH
C
C USAGE:    CALL CZEROVBL(VBLCOPY,NG,IADDRGDP)
...
C--------
         ...
         MADDVC=IADDRGDP(2,NG)-1
         MADDTC=IADDRGDP(3,NG)-1
         MADDQC=IADDRGDP(4,NG)-1
         MADDHC=IADDRGDP(5,NG)-1
         DO 100 K=1,KM
           DO 50 I=1,IJ
             VBLCOPY(MADDUC+I)=0.
             VBLCOPY(MADDVC+I)=0.
