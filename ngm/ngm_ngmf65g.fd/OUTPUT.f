...
C
      DATA PLOUT/1.E0,.95E0,.9E0,.85E0,.8E0,.75E0,.7E0,.65E0,
     1           .6E0,.55E0,.5E0,.45E0,.4E0,.35E0,.3E0,.25E0,
     2           .2E0,.15E0,.1E0,.05E0/
C
C         THE FOLLOWING ARE THE HEIGHTS OF THE 'FD' WINDS.
      DATA HTFD/914.E0,1524.E0,1829.E0,2134.E0,2743.E0,3658.E0/
...
c    1             LABEL84,IOUTUNIT )
      do k = 1, 27
        print *,' output ',k,label84(k)
      enddo
      
      CALL GRIBIT (S(MSOUT2),IJOUT,S(MSOUT1),DESCRIPT(NCARD),
     1             LABEL84,IOUTGRIB )
C
   63 CONTINUE
C
...
C                 UPDATE THE LABEL
      ...
      S1VALUE = 0.E0
              CALL OUTNULAB
C                     GO TO THE PACKER CODE
      CALL OUTPACK(S(MSOUT2),IJOUT,S(MSOUT1),DESCRIPT(NCARD),
     1             LABEL84,IOUTUNIT )
      CALL GRIBIT (S(MSOUT2),IJOUT,S(MSOUT1),DESCRIPT(NCARD),
     1             LABEL84,IOUTGRIB )
...
C
        CALL OUTNULAB
        CALL OUTPACK( S(JSCR2(1)),IJOUT, S(JSCR2(2)), DESCRIPT(NCARD),
     1   LABEL84, IOUTUNIT )
        CALL GRIBIT ( S(JSCR2(1)),IJOUT, S(JSCR2(2)), DESCRIPT(NCARD),
     1   LABEL84, IOUTGRIB )
C
C------       REPAIR THE DAMAGE
      IF( N .NE. 1 ) GO TO 228
...
C
        CALL OUTPACK(S(IADVEL),IJOUT,S(MSOUT1),DESCRIPT(NKARD),
     1  LABEL84,IOUTUNIT)
        CALL GRIBIT (S(IADVEL),IJOUT,S(MSOUT1),DESCRIPT(NKARD),
     1  LABEL84,IOUTGRIB)
C
...
C
         CALL OUTNULAB
         CALL OUTPACK(S(JSCR2(2)),IJOUT,S(MSOUT2),DESCRIPT(NCARD),
     1                LABEL84,IOUTUNIT )
         CALL GRIBIT (S(JSCR2(2)),IJOUT,S(MSOUT2),DESCRIPT(NCARD),
     1                LABEL84,IOUTGRIB )
