      SUBROUTINE SNO16GET(SCVH,IYR,IMN,IDY,   INSNOIMS, LIST) 
C                                             
...
C  
      ...
      LOGICAL BITMAP(1024,1024)
      INTEGER KPDS(25), KGDS(22), JPDS(25), JGDS(22)
C
      CALL BAOPEN(INSNOIMS,'fort.22',IRETO)
      JPDS = -1
      CALL GETGB(INSNOIMS,0,1024*1024,0,JPDS,JGDS,KF,KNUM,KPDS,KGDS,
     &     BITMAP,ICE,IRET1)
      WRITE(6,*) 'AFTER GETGB FOR IMS ICE, IRET1=', IRET1
C
      JPDS = -1
      CALL GETGB(INSNOIMS,0,1024*1024,1,JPDS,JGDS,KF,KNUM,KPDS,KGDS,
     &     BITMAP,SCVH,IRET2)
      WRITE(6,*) 'AFTER GETGB FOR IMS SNOW, IRET2=', IRET2
C
      IF (IRET1.NE.0 .OR. IRET2.NE.0) THEN
         WRITE(LIST,*) 'READ ERROR FOR IMS SNOW/ICE, IRET1=',IRET1,
     &      ' IRET2=', IRET2
         CALL EXIT(16)
      ENDIF
C
