...
C     DO 115 K=1, IKM
      DO 115 K=1, 1
      PRINT 2222,K,(ULB(I,K),I=1175,1182)
      PRINT 3333,K,(TMP(I,K),I=1175,1182)
 115  CONTINUE
      DO 120 K=1, IKM
      DO 120 I=1,IJMLB
      ULB(I,K) = TMP(I,K)
...
C     DO 215 K=1, IKM
      DO 215 K=1, 1
      PRINT 2222,K,(VLB(I,K),I=1175,1182)
      PRINT 3333,K,(TMP(I,K),I=1175,1182)
 215  CONTINUE
      DO 220 K=1, IKM
      DO 220 I=1,IJMLB
...
C     DO 315 K=1,KM,5
      DO 315 K=1, 1
      PRINT 2222,K,(TLB(I,K),I=1175,1182)
      PRINT 3333,K,(TMP(I,K),I=1175,1182)
 315  CONTINUE
      DO 320 K=1, IKM
      DO 320 I=1,IJMLB
...
C     DO 415 K=1, IKM ,5
      DO 415 K=1, 1
      PRINT 2222,K,(QLB(I,K),I=1175,1182)
      PRINT 3333,K,(TMP(I,K),I=1175,1182)
 415  CONTINUE
      DO 420 K=1, IKM
      DO 420 I=1,IJMLB
