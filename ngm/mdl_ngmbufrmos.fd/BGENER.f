      SUBROUTINE BGENER(NSTA,CSTA,RDATA,KDATA,ID,LPROJ,IMOS,SCALE,
     *           REF,NDATE,MAXSTA,NUMPRJ,IVPRJ,NVPRJ,ICND)
C$$$  SUBPROGRAM DOCUMENTATION BLOCK                                    
C                .      .    .                                       .  
C SUBPROGRAM:    BGENER      GETS DATA THAT DO NOT NEED CONVERSION 
C   PRGMMR: GILBERT          ORG: W/OSD211   DATE: 93-07-29             
C                                                                       
C ABSTRACT: READS DATA THAT DO NOT NEED ANY SPECIAL CONVERSION,    
...
C                                                                       
C        PURPOSE                                                        
C            READS DATA THAT DO NOT NEED ANY SPECIAL CONVERSION,   
C            PERFORMS THE APPROPRIATE SCALING.  THE DATA ARE ADDED TO   
C            KDATA(,) FOR LATER USE IN PACKING.  MISSING VALUES (9999)  
C            ARE INSERTED FOR PROJECTIONS AT WHICH THE DATA ARE NOT
C            FOUND OR VALID.                                            
...
C        DATA VALUE                                                     
 ...
 225      FORMAT(' ERROR READING DATA: ID = ',4I10)
        ENDIF
 250    DO 300 I=1,NSTA
          KDATA(I,L)=9999
 300    CONTINUE
