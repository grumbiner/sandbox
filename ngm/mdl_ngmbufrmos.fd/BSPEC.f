      SUBROUTINE BSPEC(NSTA,KDATA,NVAL,SCALE,REF,MAXSTA,NUMPRJ,LPROJ,
     *           IVPRJ,NVPRJ)
C$$$  SUBPROGRAM DOCUMENTATION BLOCK                                    
C                .      .    .                                       .  
C SUBPROGRAM:    BSPEC       STORES USER SPECIFIED VALUE                
C   PRGMMR: GILBERT          ORG: W/OSD211   DATE: 92-07-17             
C                                                                       
C ABSTRACT: STORES A USER SPECIFIED VALUE FOR SPECIFIED PROJECTIONS     
C           INTO KDATA(,) TO BE PACKED LATER.  ALSO, THE SPECIFIED      
C           VALUE IS SCALED ACCORDINGLY.                                
C                                                                       
...
C                                                                       
C        PURPOSE                                                        
C            STORES A USER SPECIFIED VALUE FOR SPECIFIED PROJECTIONS    
C            INTO KDATA(,) TO BE PACKED LATER.  ALSO, THE SPECIFIED     
C            VALUE IS SCALED ACCORDINGLY.                               
C                                                                       
C        DATA SET USE                                                   
...
C               NVAL = USER SPECIFIED VALUE TO BE INSERTED IN THE       
C                      BUFR MESSAGE.                                    
