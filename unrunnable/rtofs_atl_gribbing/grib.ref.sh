...
if [ ! -f archv.b ] ; then
  cp $ARCHDIR/archv.2005_204_00.b  archv.b
fi
if [ ! -f archv.a ] ; then
  cp $ARCHDIR/archv.2005_204_00.a  archv.a
fi
...
6000    'z    '  = sample depth
 ...
 83     'sshio ' = sea surface height 
 84     'uvmio ' = mix layer u-vel 
 85     'vvmio ' = mix layer v-vel 
 86     'sstio ' = mix later temperature 
 87     'sssio ' = mix later salinity 
 88     'ssdio ' = mix later density 
...
${execnc}/archvgrib < archv2ncdf3z.in > archvgrib.log
