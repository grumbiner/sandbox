...
C     Parameter identification and packing material
      mxbit  = 12 !maximum # bits to use, 0 -> infinit
      parmno = 91 !sea ice
      iptv  =  1  !parameter table version
      ids    = 2  !decimal digits precision 
      verfhr = 0
      itl = 102
      il1 = 0
      il2 = 0
...
CD      ortru =  -90.-80
CD      PROJ = 1
CD      CALL gribit(ssh, lbm, 5, im, jm, mxbit, colat1,
CD     &            ilpds, iptv, icen, igen, ibms, parmno, 102, 0, 0,
CD     &                  yy, mmm, dd,runhour,
CD     &                  IFTU,IP1,IP2,ITR,INA,INM,IDS,
CD     &                  xlat1,xlon1,xlat2,xlon2,delx,dely,ORTRU,PROJ,
CD     &                  gridno,
CD     &                  grib,lgrib,ierr)
