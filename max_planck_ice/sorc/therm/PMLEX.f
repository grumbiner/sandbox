...
C-----------------------------------------------------------------------
      IF (overload(QS, L+1, M+1, 350, .FALSE.)) THEN
        PRINT *,'QS over 350 on entry to PMLEX'
      ENDIF
      IF (overload(QT, L+1, M+1, 350, .FALSE.)) THEN
        PRINT *,'QT over 350 on entry to PMLEX'
      ENDIF
...
C      BG addition for robustness
  ...
  140 CONTINUE
      IF (overload(QS, L+1, M+1, 350, .FALSE.)) THEN
        PRINT *,'QS over 350 after do 140 in PMLEX'
      ENDIF
      IF (overload(QT, L+1, M+1, 350, .FALSE.)) THEN
        PRINT *,'QT over 350 after do 140 in PMLEX'
      ENDIF
...
C-----------------------------------------------------------------------
      IF (overload(QS, L+1, M+1, 350, .FALSE.)) THEN
        PRINT *,'QS over 350 before VERDIF'
      ENDIF
      IF (overload(QT, L+1, M+1, 350, .FALSE.)) THEN
        PRINT *,'QT over 350 before VERDIF'
      ENDIF
      CALL VERDIF(QDS, QDT, QS, QT, HS, HT, QSB, QTB, QH, QHB)
      IF (overload(QS, L+1, M+1, 350, .FALSE.)) THEN
        PRINT *,'QS over 350 after VERDIF'
      ENDIF
      IF (overload(QT, L+1, M+1, 350, .FALSE.)) THEN
        PRINT *,'QT over 350 after VERDIF'
      ENDIF
...
C-----------------------------------------------------------------------
  200 CONTINUE
      IF (overload(QS, L+1, M+1, 350, .FALSE.)) THEN
        PRINT *,'QS over 350 before ADJUEX'
      ENDIF
      IF (overload(QT, L+1, M+1, 350, .FALSE.)) THEN
        PRINT *,'QT over 350 before ADJUEX'
      ENDIF
      CALL ADJUEX(QHST,SNOW,FLAGI, OM, TMP, TMP2, TMP3,
     1  QS, QSB, QT, QTB, QH, QHB, QDS, QDT, HS, HT, MLFIX)
      IF (overload(QS, L+1, M+1, 350, .FALSE.)) THEN
        PRINT *,'QS over 350 after ADJUEX'
      ENDIF
      IF (overload(QT, L+1, M+1, 350, .FALSE.)) THEN
        PRINT *,'QT over 350 after ADJUEX'
      ENDIF
C-----------------------------------------------------------------------
...
C  OVERTURNING IN OPEN OCEAN:
  ...
  270 CONTINUE
      ...
      IF (overload(QS, L+1, M+1, 350, .FALSE.)) THEN
        PRINT *,'QS over 350 before 2nd VERDIF'
      ENDIF
      IF (overload(QT, L+1, M+1, 350, .FALSE.)) THEN
        PRINT *,'QT over 350 before 2nd VERDIF'
      ENDIF
      CALL VERDIF(QDS, QDT, QS, QT, HS, HT, QSB, QTB, QH, QHB)
      IF (overload(QS, L+1, M+1, 350, .FALSE.)) THEN
        PRINT *,'QS over 350 after 2nd VERDIF'
      ENDIF
      IF (overload(QT, L+1, M+1, 350, .FALSE.)) THEN
        PRINT *,'QT over 350 after 2nd VERDIF'
      ENDIF
      DO 280 J=1,MM
      DO 280 I=0,L
...
CD         IF (bathy(i,j) .GT. 1.0 )) PRINT *,'applying hml fix ',i,j
  ...
  280 CONTINUE
      ...
      IF (overload(QS, L+1, M+1, 350, .FALSE.)) THEN
        PRINT *,'QS over 350 before 2nd ADJUEX'
      ENDIF
      IF (overload(QT, L+1, M+1, 350, .FALSE.)) THEN
        PRINT *,'QT over 350 before 2nd ADJUEX'
      ENDIF
      CALL ADJUEX(QHST,SNOW,FLAGI, OM, TMP, TMP2, TMP3,
     1  QS, QSB, QT, QTB, QH, QHB, QDS, QDT, HS, HT, MLFIX)
      IF (overload(QS, L+1, M+1, 350, .FALSE.)) THEN
        PRINT *,'QS over 350 after 2nd ADJUEX'
      ENDIF
      IF (overload(QT, L+1, M+1, 350, .FALSE.)) THEN
        PRINT *,'QT over 350 after 2nd ADJUEX'
      ENDIF
...
CD      CALL VECMIN(QDS,HMLREF,QDS)
CD      CALL VECMIN(QDT,HMLREF,QDT)
CD      CALL VECMIN(QH,HMLREF,QH)
