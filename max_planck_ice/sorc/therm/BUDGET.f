...
C-----------------------------------------------------------------------
   ...
   34  CONTINUE
CD       PRINT *,'Maximum delta (in budget) = ',delmax
...
CERR       ALB1(N) = albedo(t1(N), ta1(N), hice1(N), hsnow1(N)) 
       ALB1(N) = albedo(t1(N), ta1(N), hsnow1(N), hice1(N) ) 
...
CBG       FLLA1(N) = D2I*UG1(N)* (EA-ESTI(N)) * EPSI/PA1(N)
