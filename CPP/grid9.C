...
////////////////////////////////////////////////////////////////////////
  ...
  ijpt lower_left, upper_right;
  latpt llpt;
  lower_left.i = x1; lower_left.j = y1;
  upper_right.i = x2; upper_right.j = y2;
  llpt = b.locate(lower_left);
  fprintf(cgilog, "lower left corner lat lon %f %f \n",llpt.lat, llpt.lon);
  llpt = b.locate(upper_right);
  fprintf(cgilog, "upper_right corner lat lon %f %f \n",llpt.lat, llpt.lon);
...
//  }
  ...
  e.colorproc(eland, 7, 65, std_ice_coloring);
  e.xpm("e.xpm", 1, gg);
