...
C     PERH LONGITUDE OF PERIHELION
      ...
      REAL DUM, XOB, ECC, PRE, PERH 
  
      REAL ADELTA, DELTA, RDELTA
      REAL ALM, ALMINC, ANV, RANV, RANM 
      REAL APHI, RPHI, AT, TT, CD, CP 
      REAL DLAM, RLAM, RAU, RDAYL, RSQIN, RSQPIN
      REAL SD, SF, SO, SP, SPD, STP, TP, TEST, S 
      REAL XEE, XL, XLAM, XLLP, XSE 
  
      COMMON/TEMP/INSOL 
      REAL INSOL, PI, PIR, SC
      
CD      SAVE PI, SC, DUM, XOB, ECC, PRE, PERH
