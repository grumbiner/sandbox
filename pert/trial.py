...
#G.add_node(0, what="start", who='rg', time=0, weight=0)
#G.add_node(1, what="code drifter", who='rg', time=10, weight=10)
#G.add_node(2, what="code retail verification", who='rg', time=4, weight=222)
#G.add_node(3, what="apply to RTOFS", who='rg', time=8, weight=8)
#G.add_node("end", weight=0)
G.add_node(0, what="start", who='rg', time=0)
G.add_node(1, what="code drifter", who='rg', time=4)
...
for i in range(1,len(k)):
  ...
  print("step:",i, "node:",k[i], "time:",G.nodes[k[i]]['time'])
  sum += float(tau)
