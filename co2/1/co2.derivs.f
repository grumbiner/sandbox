...
C     Carbon 14 Parameters:
      ...
      REAL aafudg, nafudg, wofudg, sufudg
...
C     delta C14
     ...
     4                       (c14ls*tco2(4)-x(7)*tco2(3))*wofudg
     5            + qwc14                       )
     6       /vw
     ...
     4            +diffv* as*2./href/(1.-zeta)*
     4                    (x(7)*tco2(3)-c14ls*tco2(4))*wofudg
     5            +diffv*as*2./mixed*tco2(4)*(c14sat-c14ls)*sufudg
     4            + qsc14 
     5         ) /vs
