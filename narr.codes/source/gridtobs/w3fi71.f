...
C
C these are WRF HIRESW grids (235=East,236=West,237=Cent) from Matt Pyle
C these are the 8 km grids - no longer used
C
c     DATA  GRD235/ 0, 255, 3, 336,372,  22980,   -92840,  8,  -80000,
c    &    8000,    8000, 0, 64, 0, 35000, 35000, 0, 0/
c     DATA  GRD236/ 0, 255, 3, 332,371,  25970,   -127973,  8,  -115000,
c    &    8000,    8000, 0, 64, 0, 40000, 40000, 0, 0/
c     DATA  GRD237/ 0, 255, 3, 336,372,  22980,   -110840,  8,  -98000,
c    &    8000,    8000, 0, 64, 0, 35000, 35000, 0, 0/
C
C these are WRF HIRESW grids (235=East,236=West,237=Cent) from Matt Pyle
C these are the 10 km grids
C
      DATA  GRD235/ 0, 255, 3, 269,298,  22969,   -94323,  8,  -81500,
     &    10000,    10000, 0, 64, 0, 35000, 35000, 0, 0/
      DATA  GRD236/ 0, 255, 3, 269,298,  25971,   -127965,  8,  -115000,
     &    10000,    10000, 0, 64, 0, 40000, 40000, 0, 0/
      DATA  GRD237/ 0, 255, 3, 269,298,  22973,   -110832,  8,  -98000,
     &    10000,    10000, 0, 64, 0, 35000, 35000, 0, 0/
      DATA  GRD238/ 0, 255, 3, 269,298,  46149,   -165404,  8,  -145000,
     &    10000,    10000, 0, 64, 0, 63000, 63000, 0, 0/
C
c     DATA  GRD238/ 0, 255, 0, 275, 203,  50750, 261750,  72,    -205,   
c    &   -29750, 0,  0, 64, 0, 0, 0, 0, 0/
     ...
     &   20317,  20317, 0, 64, 0, 25000, 25000, 0, 0/
      DATA  GRD253/ 0, 255, 0, 373,183,   5025, -170250,  72,    4750,
