...
C$$$
      ...
      INCLUDE "parmanl"
      DIMENSION TS( IMAX , 50 ),PS( IMAX , 50 )
      DIMENSION PT( 50 ),PI( 50 ),NCOUNT( 50 )
      DIMENSION DMEAN( 50 ),RMSTD( 50 ),TDMAX( 50 )
      DIMENSION MAXI( 50 ),MAXJ( 50 )
      DATA NCOUNT,DMEAN/ 50 *0, 50 *0.0/
      DATA RMSTD,TDMAX/ 50 *0.0, 50 *0.0/
      DATA MAXI,MAXJ/ 50 *0, 50 *0/
      KLEVM1= KLEV - 1
      ROCP = 287.05 / 1005.
      XSTO = 0.0
