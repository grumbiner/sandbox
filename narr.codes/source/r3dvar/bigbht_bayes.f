subroutine bigbht_bayes( &
              qetaanl,xbarq,rq,mqdata,ibighq,bighq,isofilter_q, &
              xbarpw,mpwdata,ibighpw,bighpw, &
              wetaanl,xbarw,rw,mwdata,ibighw,bighw,isofilter_psi,isofilter_chi, &
              petaanl,xbarps,rp,mpdata,ibighp,bighp,isofilter_p, &
              tetaanl,xbart,rt,mtdata,ibight,bight,isofilter_t, &
              xbarrad,rpred,mraddata,ibighradh,bighradh,bighradv, &
                predrad,icxrad,varpred,npred,userad, &
         lbig2data,lbig2ges,lbig3ges,qsateetaanl,bigeetah,ibigeetah,bigeetav,ibigeetav, &
...
!    h stuff:
  ...
  real(4),allocatable::resp(:,:),resps(:)                  ! intermediate non-linear residuals
...
!   now apply C Eeta H
  ...
  qetaanl=qetaanl+qetadir
  wetaanl=wetaanl+wetadir
  tetaanl=tetaanl+tetadir
  petaanl=petaanl+petadir
