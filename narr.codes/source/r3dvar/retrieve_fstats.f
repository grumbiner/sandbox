subroutine retrieve_fstats(sigtheta1_in,wspd2_in,rldq3_in,v,x)
...
!  get variance, correlation lengths 
  ...
  common/aniso_fstats/n1,n2,n3,sigtheta1,wspd2,rldq3,qlens,stdqs,d1,d2,d3
  common/aniso_fstats/ del1i,del2i,del3i
...
return
end subroutine retrieve_fstats

subroutine retrieve_fstats0(instats)
...
return
end subroutine retrieve_fstats0
