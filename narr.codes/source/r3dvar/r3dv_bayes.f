...
!---  delhour_sfc:   defines size of time window for surface data.
!---  plimit_sfc:    define lower pressure limit for using surface data
...
!----------
 ...
 use transmittance_coefficients
  ...
  namelist/namr3dv/ &
    ...
    corlmin,corlmax, &
    delhour,delhour_sfc,plimit_sfcq,plimit_sfct,plimit_sfcw,grossp,grosspw,grossq,one_pres, &
  ...
  data  &
     ...
     bscalepsi/.5/,bscalechi/.2/,bscalepred/1./,delhour/1.5/,delhour_sfc/.5/, &
     plimit_sfcq/0./,plimit_sfct/0./,plimit_sfcw/0./, &
...
!--------------------------------need on output
  ...
  if(mype.eq.0) then
   ...
   print *,' bscalepsi,bscalechi,bscalepred=', &
              bscalepsi,bscalechi,bscalepred
   print *,' delhour,delhour_sfc,plimit_sfcq,t,w,grossp,grosspw,grossq=', &
               delhour,delhour_sfc,plimit_sfcq,plimit_sfct,plimit_sfcw,grossp,grosspw,grossq
...
!--------  1.  unbufrize data, count and store on temporary files
  ...
  call rdtest(inbufr,nbufdat,mbufdat,nbufrad,mbufrad, &
              ...
              plimit_sfcq,plimit_sfct,plimit_sfcw,userad,drift, &
