subroutine restore_eta_ges(tetaanl,qetaanl,q2etaanl,cwmetaanl,uetaanl,vetaanl,pdetaanl,imeta,jmeta,lmeta)
...
!  now, do halo exchange on variables
       ...
       return
       end subroutine restore_eta_ges
