...
C
      ...
      READ (33) 
      READ (33) GFHR,IGDATE
c     READ (33) GFHR,IGDATE,NGLONS,NGLATS,NUM
...
C  BYPASS THE SURFACE TEMPERATURE RECORD
      ...
      print*,'ggrid1(1,1)=',ggrid1(1,1)
      print*,'ggrid1(192,94)=',ggrid1(192,94)
C  READ AND SAVE THE TWO-LAYER SOIL MOISTURE RECORDS
      READ (33) GGSMC2
      print *,'ok after rec 2 in sfcanl'
      print*,'ggsmc2(1,1,1)=',ggsmc2(1,1,1)
      print*,'ggsmc2(1,1,2)=',ggsmc2(1,1,2)
      print*,'ggsmc2(192,94,1)=',ggsmc2(192,94,1)
      print*,'ggsmc2(192,94,2)=',ggsmc2(192,94,2)
