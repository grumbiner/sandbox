...
//   makes no sense that this is the case, as the 'matchup'
//   class does not have a lot of data to it.
#define MAXBUOYS (256*1024 + 128*1024)
...
int main(int argc, char *argv[]) {
  ...
  int fday = 0, skpt, month, year, maxdays;
  float ia, correl, vcc;
  float b0, b1;
