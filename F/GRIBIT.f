...
CO        LONI=NINT(360.E3/IM)
      ...
      IF(NBM.EQ.0) THEN
        ...
        NBIT=0
      ELSE
CD        CALL GETBIT(IBM,IBS,IDS,LEN,MG,G,GROUND,GMIN,GMAX,NBIT)
COLD        CALL GTBITS(IPDS(7),IDS,NF,IBM,F,FR,FMIN,FMAX,NBIT)
          IBS = 0
          CALL GETBIT(IBM,IBS,IDS,NF,IBM,F,FROUND,FMIN,FMAX,NBIT)
