C This program calculates the mse, a skill score, and the correlation
C coefficient of a list of numbers.
...
CD      PRINT *,  'refX1 =   ', ref1
     ...
     2 (SQRT(n*sumA (X,n) - ((sumX (X,n))**2)))))**2
