...
int main(int argc, char *argv[]) {
  northgrid<float> fcst, ref, obs;
  mvector<float> scores(10);
  FILE *ffin, *frefin, *fobsin;
  int i, j, k;
...
void scorer(grid2<float> &fcst, grid2<float> &obs, grid2<float> &ref, mvector<float> &score) {
