...
export PDY=${PDY:-20221202}
export PDYm1=${PDYm1:-20221201}
#export end=20220731
export end=20230331
...
do
  ...
  if [ ! -f $COMOUT/out.$PDY ] ; then
    echo zzz time $HOME/rgdev/new_concentrations/amsr2/sorc/amsr2_l1b_scan $COMOUT/amsr2.$PDY hr lr $COMOUT/ice.$PDY > txt.$PDY
