...
!
! NAME:
!    amsr2_1b_attr_read_hdf5_interface
!
! CALLING SEQUENCE:
!    USE amsr2_1b_attr_read_hdf5_interface
!
! INPUTS:
!     NONE
!
...
MODULE amsr2_1b_attr_read_hdf5_interface
...
END MODULE amsr2_1b_attr_read_hdf5_interface
