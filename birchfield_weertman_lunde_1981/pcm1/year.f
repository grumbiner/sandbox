...
CLINUX      CALL READMS(15,WW,KPHI,JM)
CLINUX      CALL READMS(15,COSZB,KPHI,JM+KYEAR) 
...
CLINUX      IF (IRW.EQ.0) CALL OPENMS(15,INDEX,IXSZ15,0)
      TEST=0.0001 
      PIR=PI/180. 
...
C     EQUATOR 
  ...
  200 CONTINUE
CLINUX      CALL WRITMS(15,WW,KPHI,JJ,IRW,0)
CLINUX      CALL WRITMS(15,COSZB,KPHI,JJ+KYEAR,IRW,0) 
  100 CONTINUE
      IRW=-1
